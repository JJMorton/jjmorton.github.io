...
window.addEventListener("load", function () {
    ...
    let integrator = new Integrators.RK4Integrator(accelerationCalculator, new Vector([sim.percToM(50), sim.percToM(20)]), new Vector([0, 0]), 0.1);
    ...
    function accelerationCalculator({ pos, vel }) {
