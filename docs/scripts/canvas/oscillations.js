...
window.addEventListener("load", function () {
    ...
    const getDriverPos = (time) => params.d_a * Math.cos(2 * Math.PI * params.d_f * time + params.d_phi) + params.d_l;
    const getEquilibrium = (time) => params.l + params.m * params.g / params.k + getDriverPos(time);
